...
imgFOLDER=`dirname $BASH_SOURCE`/images/Microchip/startupSystem_2024/ #END WITH / please!!!!
...
#lta sseq sequencers/sequencer_microchip_binned_brenda_reverseOS.xml
#doRaw
...
do
	...
	source voltages/voltage_skp_lta_v82_microchip.sh
	...
	rows=50; nsmpls=225; expo=0;
	doSettings
	
	lta name $imgFOLDER/skp_${runname}_NSAMP_${nsmpls}_NROW_${rows}_NCOL_${cols}_EXPOSURE_${expo}_NBINROW_${binrow}_NBINCOL_${bincol}_img_
	lta read
