...
#
#rutine in progress: 
rutine="Take Images to Ser Reg Test Events"
#
##
timeStart=$(date)
...
imgFOLDER=`dirname $BASH_SOURCE`/images/Microchip/serialRegTest/AGO24/serTest_160k_SER/ #END WITH / please!!!!
# path of ser test events files /home/detectores/Software/ltaDaemon-master/images/Microchip/serialRegTest/03NOV23/serTest
runname=m-009_microchip_T_160_
...
do
	...
	#lta sseq sequencers/sequencer_microchip_binned_brenda.xml  # regular images
        lta sseq sequencers/sequencer_microchip_binned_brenda_VA.xml # Ser Reg Events
	cols=700;rows=400; nsmpls=324; expo=0;
	doSettings
