...
#
#rutine in progress: 
rutine="generic loop, take 1 image at 1 nsamp and 1 image at 225 nsamp"
#
###
timeStart=$(date)
...
imgFOLDER=`dirname $BASH_SOURCE`/images/Microchip/14AGO2023/spuriousTest/ #END WITH / please!!!!
...
for loop in {1..1}
do
	cols=700; rows=650; nsmpls=225; expo=0; binrow=1; bincol=1;  #Cambiar a Row = 50
