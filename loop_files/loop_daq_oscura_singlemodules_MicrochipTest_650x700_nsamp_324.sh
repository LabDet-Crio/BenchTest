...
imgFOLDER=`dirname $BASH_SOURCE`images/Microchip/serialRegTest/03NOV23/serTest/650x700/nsamp_324/ #END WITH / please!!!!
#images/Microchip/serialRegTest/03NOV23/serTest/
...
do
	...
	cols=700;rows=650; nsmpls=324; expo=0;
	doSettings
