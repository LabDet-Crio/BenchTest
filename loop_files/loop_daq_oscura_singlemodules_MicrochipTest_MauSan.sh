...
#imgFOLDER=`dirname $BASH_SOURCE`/images/Microchip/01NOV2023/EXPOSURE_0/NSAMP_324/400x700_A/ #END WITH / please!!!!
imgFOLDER=`dirname $BASH_SOURCE`/images/Microchip/11ENE2024/EXPOSURE_0/NSAMP_225/40x700/
...
do
	...
	cols=700;rows=40; nsmpls=225; expo=0;
	doSettings
